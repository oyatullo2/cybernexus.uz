...
export const Contact = () => {
  ...
  return (
    <>
      <div className="w-full mt-[-50px] animate-[header-top-animation_1.6s_ease-in-out] flex flex-col items-center max-w-full h-screen overflow-hidden justify-center">
        <h2
